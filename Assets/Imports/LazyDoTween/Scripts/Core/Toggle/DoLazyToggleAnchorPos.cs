...
{
    public class DoLazyToggleAnchorPos : DoLazyToggleBase<RectTransform, Vector2>
    {
        ...
        private void Toggle(Vector2 to, Ease ease, AnimationCurve easeCurve, UnityEvent onComplete)
        {
            Kill();
