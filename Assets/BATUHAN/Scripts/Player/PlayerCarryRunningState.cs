...
public class PlayerCarryRunningState : PlayerBaseState
{
    ...
    {
        Debug.Log("hello from the carry running state");
        ...
        player.GetComponent<Animator>().SetBool("carryRunning", true);
    }
